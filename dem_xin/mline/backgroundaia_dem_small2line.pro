; .r backgroundaia_dem_small2line
; xrt_dem_iterative2
; aia_dem_setup_x
...
xdems1=[1036.0+1,1036.0-7,1036.0-10]
xdems2=[-1031.0-1,-1031.0+7,-1031.0+10]
ydems1=[-49.0-5,-49.0-5,-49.0-5]
ydems2=[51.0+5,51.0+5,51.0+5]
...
fits2map,file131[k0],stitle
title=strmid(stitle.time,0,11)+'_'+strmid(stitle.time,12,2)+'_'+strmid(stitle.time,15,2)+'_'+strmid(stitle.time,18,2)
; title=strmid(smap1[0].time,0,11)+'_'+strmid(smap1[0].time,12,2)+'_'+strmid(smap1[0].time,15,2)+'_'+strmid(smap1[0].time,18,2)
save,result,smap10,smap20,smap30,smap40,smap50,smap60,filename=dir2+'bsDEM'+title+'.sav'
